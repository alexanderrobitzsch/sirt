...
Rcpp::NumericMatrix sirt_rcpp_xxirt_compute_likelihood_person_covariates(Rcpp::IntegerMatrix dat, Rcpp::LogicalMatrix dat_resp_bool, Rcpp::NumericVector probs, int TP, int maxK);
RcppExport SEXP _sirt_sirt_rcpp_xxirt_compute_likelihood_person_covariates(SEXP datSEXP, SEXP dat_resp_boolSEXP, SEXP probsSEXP, SEXP TPSEXP, SEXP maxKSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type dat(datSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type TP(TPSEXP);
    Rcpp::traits::input_parameter< int >::type maxK(maxKSEXP);
    rcpp_result_gen = Rcpp::wrap(sirt_rcpp_xxirt_compute_likelihood_person_covariates(dat, dat_resp_bool, probs, TP, maxK));
    return rcpp_result_gen;
END_RCPP
}
// sirt_rcpp_xxirt_compute_loglike_case_theta_covariates
Rcpp::NumericMatrix sirt_rcpp_xxirt_compute_loglike_case_theta_covariates(Rcpp::IntegerMatrix dat, Rcpp::LogicalMatrix dat_resp_bool, Rcpp::NumericVector logprobs, int TP, int maxK);
RcppExport SEXP _sirt_sirt_rcpp_xxirt_compute_loglike_case_theta_covariates(SEXP datSEXP, SEXP dat_resp_boolSEXP, SEXP logprobsSEXP, SEXP TPSEXP, SEXP maxKSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type dat(datSEXP);
    Rcpp::traits::input_parameter< Rcpp::LogicalMatrix >::type dat_resp_bool(dat_resp_boolSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type logprobs(logprobsSEXP);
    Rcpp::traits::input_parameter< int >::type TP(TPSEXP);
    Rcpp::traits::input_parameter< int >::type maxK(maxKSEXP);
    rcpp_result_gen = Rcpp::wrap(sirt_rcpp_xxirt_compute_loglike_case_theta_covariates(dat, dat_resp_bool, logprobs, TP, maxK));
    return rcpp_result_gen;
END_RCPP
}
...
double sirt_rcpp_xxirt_newton_raphson_derivative_par(Rcpp::IntegerMatrix dat, Rcpp::LogicalMatrix dat_resp_bool, Rcpp::NumericMatrix ratio, Rcpp::NumericMatrix p_xi_aj, int item, Rcpp::NumericMatrix prior_Theta, Rcpp::IntegerVector group0, Rcpp::NumericVector weights, Rcpp::NumericVector ll_case0, double eps, bool person_covariates, bool person_covariates_items);
RcppExport SEXP _sirt_sirt_rcpp_xxirt_newton_raphson_derivative_par(SEXP datSEXP, SEXP dat_resp_boolSEXP, SEXP ratioSEXP, SEXP p_xi_ajSEXP, SEXP itemSEXP, SEXP prior_ThetaSEXP, SEXP group0SEXP, SEXP weightsSEXP, SEXP ll_case0SEXP, SEXP epsSEXP, SEXP person_covariatesSEXP, SEXP person_covariates_itemsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type dat(datSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type eps(epsSEXP);
    Rcpp::traits::input_parameter< bool >::type person_covariates(person_covariatesSEXP);
    Rcpp::traits::input_parameter< bool >::type person_covariates_items(person_covariates_itemsSEXP);
    rcpp_result_gen = Rcpp::wrap(sirt_rcpp_xxirt_newton_raphson_derivative_par(dat, dat_resp_bool, ratio, p_xi_aj, item, prior_Theta, group0, weights, ll_case0, eps, person_covariates, person_covariates_items));
    return rcpp_result_gen;
END_RCPP
}
// sirt_rcpp_xxirt_nr_pml_opt_fun
Rcpp::List sirt_rcpp_xxirt_nr_pml_opt_fun(Rcpp::NumericVector prior_Theta, Rcpp::NumericVector probs_items, Rcpp::NumericVector freq1, Rcpp::NumericVector freq2, Rcpp::NumericVector W1, Rcpp::NumericMatrix W2_long, int G, int K, int I, int TP, int NI2, double eps);
RcppExport SEXP _sirt_sirt_rcpp_xxirt_nr_pml_opt_fun(SEXP prior_ThetaSEXP, SEXP probs_itemsSEXP, SEXP freq1SEXP, SEXP freq2SEXP, SEXP W1SEXP, SEXP W2_longSEXP, SEXP GSEXP, SEXP KSEXP, SEXP ISEXP, SEXP TPSEXP, SEXP NI2SEXP, SEXP epsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type prior_Theta(prior_ThetaSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type probs_items(probs_itemsSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type freq1(freq1SEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type freq2(freq2SEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type W1(W1SEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type W2_long(W2_longSEXP);
    Rcpp::traits::input_parameter< int >::type G(GSEXP);
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    Rcpp::traits::input_parameter< int >::type I(ISEXP);
    Rcpp::traits::input_parameter< int >::type TP(TPSEXP);
    Rcpp::traits::input_parameter< int >::type NI2(NI2SEXP);
    Rcpp::traits::input_parameter< double >::type eps(epsSEXP);
    rcpp_result_gen = Rcpp::wrap(sirt_rcpp_xxirt_nr_pml_opt_fun(prior_Theta, probs_items, freq1, freq2, W1, W2_long, G, K, I, TP, NI2, eps));
    return rcpp_result_gen;
END_RCPP
}
// sirt_rcpp_xxirt_nr_pml_grad_fun_eval
double sirt_rcpp_xxirt_nr_pml_grad_fun_eval(Rcpp::NumericVector prior_Theta, Rcpp::NumericVector probs_items, Rcpp::NumericVector freq1, Rcpp::NumericVector freq2, Rcpp::NumericVector W1, Rcpp::NumericMatrix W2_long, int G, int K, int I, int TP, int NI2, double eps, int NP, Rcpp::NumericVector der_prior_Theta, Rcpp::NumericVector val1, Rcpp::NumericVector val2, bool pp_Theta, Rcpp::NumericVector der_probs_items, Rcpp::IntegerVector index_freq1, Rcpp::IntegerVector index_freq2);
RcppExport SEXP _sirt_sirt_rcpp_xxirt_nr_pml_grad_fun_eval(SEXP prior_ThetaSEXP, SEXP probs_itemsSEXP, SEXP freq1SEXP, SEXP freq2SEXP, SEXP W1SEXP, SEXP W2_longSEXP, SEXP GSEXP, SEXP KSEXP, SEXP ISEXP, SEXP TPSEXP, SEXP NI2SEXP, SEXP epsSEXP, SEXP NPSEXP, SEXP der_prior_ThetaSEXP, SEXP val1SEXP, SEXP val2SEXP, SEXP pp_ThetaSEXP, SEXP der_probs_itemsSEXP, SEXP index_freq1SEXP, SEXP index_freq2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type prior_Theta(prior_ThetaSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type eps(epsSEXP);
    Rcpp::traits::input_parameter< int >::type NP(NPSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type der_prior_Theta(der_prior_ThetaSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type val1(val1SEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type val2(val2SEXP);
    Rcpp::traits::input_parameter< bool >::type pp_Theta(pp_ThetaSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type der_probs_items(der_probs_itemsSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type index_freq1(index_freq1SEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type index_freq2(index_freq2SEXP);
    rcpp_result_gen = Rcpp::wrap(sirt_rcpp_xxirt_nr_pml_grad_fun_eval(prior_Theta, probs_items, freq1, freq2, W1, W2_long, G, K, I, TP, NI2, eps, NP, der_prior_Theta, val1, val2, pp_Theta, der_probs_items, index_freq1, index_freq2));
    return rcpp_result_gen;
END_RCPP
}
// sirt_rcpp_xxirt_nr_pml_casewise_opt_fun
Rcpp::List sirt_rcpp_xxirt_nr_pml_casewise_opt_fun(Rcpp::NumericVector prior_Theta, Rcpp::NumericVector probs_items, Rcpp::NumericVector W1, Rcpp::NumericMatrix W2_long, int G, int K, int I, int TP, int NI2, double eps, Rcpp::IntegerVector group0, Rcpp::NumericVector weights, Rcpp::IntegerMatrix dat1, Rcpp::LogicalMatrix dat_resp);
RcppExport SEXP _sirt_sirt_rcpp_xxirt_nr_pml_casewise_opt_fun(SEXP prior_ThetaSEXP, SEXP probs_itemsSEXP, SEXP W1SEXP, SEXP W2_longSEXP, SEXP GSEXP, SEXP KSEXP, SEXP ISEXP, SEXP TPSEXP, SEXP NI2SEXP, SEXP epsSEXP, SEXP group0SEXP, SEXP weightsSEXP, SEXP dat1SEXP, SEXP dat_respSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type prior_Theta(prior_ThetaSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type group0(group0SEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type weights(weightsSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type dat1(dat1SEXP);
    Rcpp::traits::input_parameter< Rcpp::LogicalMatrix >::type dat_resp(dat_respSEXP);
    rcpp_result_gen = Rcpp::wrap(sirt_rcpp_xxirt_nr_pml_casewise_opt_fun(prior_Theta, probs_items, W1, W2_long, G, K, I, TP, NI2, eps, group0, weights, dat1, dat_resp));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sirt_sirt_rcpp_xxirt_compute_likelihood_person_covariates", (DL_FUNC) &_sirt_sirt_rcpp_xxirt_compute_likelihood_person_covariates, 5},
    {"_sirt_sirt_rcpp_xxirt_compute_loglike_case_theta_covariates", (DL_FUNC) &_sirt_sirt_rcpp_xxirt_compute_loglike_case_theta_covariates, 5},
    {"_sirt_sirt_rcpp_xxirt_hessian_reduced_probs", (DL_FUNC) &_sirt_sirt_rcpp_xxirt_hessian_reduced_probs, 9},
    {"_sirt_sirt_rcpp_xxirt_newton_raphson_derivative_par", (DL_FUNC) &_sirt_sirt_rcpp_xxirt_newton_raphson_derivative_par, 12},
    {"_sirt_sirt_rcpp_xxirt_nr_pml_opt_fun", (DL_FUNC) &_sirt_sirt_rcpp_xxirt_nr_pml_opt_fun, 12},
    {"_sirt_sirt_rcpp_xxirt_nr_pml_grad_fun_eval", (DL_FUNC) &_sirt_sirt_rcpp_xxirt_nr_pml_grad_fun_eval, 20},
    {"_sirt_sirt_rcpp_xxirt_nr_pml_casewise_opt_fun", (DL_FUNC) &_sirt_sirt_rcpp_xxirt_nr_pml_casewise_opt_fun, 14},
    {NULL, NULL, 0}
};
